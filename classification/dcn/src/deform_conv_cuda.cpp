...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m)
{
    ...
    m.def("deform_unfold_forward_cuda", &deform_unfold_forward_cuda, "deform unfold forward (CUDA)");
    m.def("deform_unfold_backward_input_cuda", &deform_unfold_backward_input_cuda,
          "deform_unfold_backward_input (CUDA)");
}
