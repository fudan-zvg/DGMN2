...
from .dgmn2 import build_dgmn2_backbone


__all__ = ["build_dgmn2_fpn_backbone"]
...
def build_dgmn2_fpn_backbone(cfg, input_shape: ShapeSpec):
    """
    Args:
    ...
    """
    bottom_up = build_dgmn2_backbone(cfg, input_shape)
